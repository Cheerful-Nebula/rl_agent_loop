...
graph TD
    ...
    subgraph "Node 1: Linux Training Server - Execution and Physics"
        A["PPO Agent Training - Stable-Baselines3"]:::linux
        B["Gymnasium Env - LunarLander-v3"]:::linux
        C["Deterministic Translation Layer - Pandas and NumPy"]:::linux
    ...
    subgraph "Node 2: MacBook Pro M4 Max - Inference Orchestration"
        G["Strategist LLM - Hypothesis Generation"]:::llm
        H["Organizer LLM - Format Structuring"]:::llm
        I["Research Lead LLM - Executive Decision"]:::llm
        J["Dispatcher LLM - Payload Routing"]:::llm
        K["Coder LLM - Python Implementation"]:::llm
        L["Validator LLM - Post-Mortem Analysis"]:::llm

        G --> H
        H --> I
        I --> J
        J -->|Math and Constraints| K
        J -->|Hypothesis and Metrics| L
    end

    C -->|Aggregates Physics and Kinematics| D
    D -->|Context| G
    E -->|History| G
    E -->|History| I
    K -->|Overwrites| F
